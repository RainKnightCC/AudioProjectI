...
QT_MOC_LITERAL(1, 9, 11), // "bufferReady"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 12), // "QAudioBuffer"
QT_MOC_LITERAL(4, 35, 6), // "buffer"
QT_MOC_LITERAL(5, 42, 6), // "record"
QT_MOC_LITERAL(6, 49, 4), // "stop"
QT_MOC_LITERAL(7, 54, 5), // "pause"
QT_MOC_LITERAL(8, 60, 5), // "state"
QT_MOC_LITERAL(9, 66, 17) // "audioBufferProbed"

    },
    "Recorder\0bufferReady\0\0QAudioBuffer\0"
    "buffer\0record\0stop\0pause\0state\0"
    "audioBufferProbed"
};
...
void Recorder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: { int _r = _t->state();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 5: _t->audioBufferProbed((*reinterpret_cast< const QAudioBuffer(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Recorder::*_t)(const QAudioBuffer & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Recorder::bufferReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Recorder::bufferReady(const QAudioBuffer & _t1)
{
